...
import {FcComboChart,FcNews, FcGoogle, FcVoicePresentation} from 'react-icons/fc'
import {SiSpringboot,SiJsonwebtokens,SiFlask,SiJupyter,SiPandas,SiScikitlearn,SiPython, SiJavascript, SiJava, SiStyledcomponents, SiTensorflow, SiRedux, SiNumpy, SiHibernate} from 'react-icons/si'
        ...
        <div className="wrapper">
          <div className="info">
            <div className="description">
              ...
              <p>
              This app shows the stats, historical price data and predicts future prices of crypto-currencies using a deep learning model <span>( Bidirectional LSTM model )</span>.
              <br />
              The app allows you to add and delete your crypto currencies on your own cryptowatchlist.
              <br />
              The app also displays the latest news on crypto currencies from major news sources.
              <br />
              Another feature is that it has voice recognition capabilities for navigation, theme color change and the app can read the news to you using an AI voice.
              <br />
            ...
            <div  className="techstack" >
              ...
              <div className="tech-list">
                ...
                <div className="tech-id"><FcComboChart  fontSize={26}/><span>Chart js</span></div>
                <div className="tech-id"><SiRedux color='purple' fontSize={26}/><span>Redux</span></div>
                ...
                <div className="tech-id"><FcNews  fontSize={26}/><span> News API</span></div>
                <div className="tech-id"><BsCoin color='gold' fontSize={26}/><span> Coin-Ranking API</span></div>
                <div className="tech-id"><SiTensorflow color='orange' fontSize={26}/><span> Tensorflow</span></div>
                <div className="tech-id"><FcGoogle fontSize={26}/><span> Google Colab</span></div>
                <div className="tech-id"><FcVoicePresentation fontSize={26}/><span> Voice Recognition</span></div>
              </div>
            </div>
            ...
            <div className="links">
              <a href="https://github.com/mk870/React_Crypto_Frontend" target="_blank" rel='noreferrer'>
                <div className="btn"><BsCodeSlash color='red' fontSize={19}/><span>Source Code</span></div>
              </a>
              <a href="https://react-cryptomania.herokuapp.com" target="_blank" rel='noreferrer'>
