        ...
        <div className="wrapper">
          <div className="info">
            <div className="description">
              ...
              <p>
              This application allows you to take a picture using your device or upload a picture from your device storage,then provides you with a platform to edit the picture to your own specification and finally download the edited result.
              <br />
              <span>The editing options include:</span>  <br />
              Changing image color ( red, green, blue, yellow, purple, orange, lime and crimson). <br />
              Changing image filters ( blur, sepia, brightness, grayscale, invert, opacity, saturation,contrast ). <br />
              Adding Text and Dragging it around the image for a suitable position. <br />
            ...
            <div  className="techstack" >
              ...
              <div className="tech-list">
                ...
                <div className="tech-id"><AiOutlineHtml5 color='orange' fontSize={26}/><span>Html Canvas</span></div>
            ...
            <div className="links">
              <a href="https://github.com/mk870/React-Photo-Editor-App" target="_blank" rel='noreferrer'>
                <div className="btn"><BsCodeSlash color='red' fontSize={19}/><span>Source Code</span></div>
              </a>
              <a href="https://pixelshop-editor.netlify.app" target="_blank" rel='noreferrer'>
          ...
          <div className="image">
            <img className='photopic' src={photo} alt="photo-app" />
          </div>
        </div>
      </motion.div>
    </ProjectStyles>
