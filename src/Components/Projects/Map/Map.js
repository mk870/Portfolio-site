        ...
        <div className="wrapper">
          <div className="info">
            <div className="description">
              ...
              <p>
                This application allows you to find directions and distance
                using different types of maps on any location around the globe.
              </p>
            </div>
            <div className="techstack">
              ...
              <div className="tech-list">
                ...
                <div className="tech-id">
                  <SiMapbox color="aliceblue" fontSize={26} />
                  <span>Map box API</span>
                </div>
              </div>
            </div>
            ...
            <div className="links">
              <a
                href="https://github.com/mk870/React_Map_App"
                target="_blank"
                rel="noreferrer"
              >
                <div className="btn">
              ...
              <a
                href="https://nextgenmaps.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
                <div className="btn">
