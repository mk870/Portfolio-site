  ...
  return (
    <ProjectStyles>
      <motion.div ref={ref} animate={animation} className="project">
        <div className="name">6. Premier League Wage Prediction App</div>
        <div className="wrapper">
          <div className="info">
            <div className="description">
              <span className="sub-head">App Description:</span>
              <p>
                This app allows you to predict an English Premier League
                player's weekly wages based on their physical, contractual and
                perfomance attributes. ( based on the 2020/21 season )
                <br />
                The app uses Machine Learning for this task{" "}
            ...
            <div className="techstack">
              ...
              <div className="tech-list">
                ...
                <div className="tech-id">
                  <GiOctopus color="#0471bf" fontSize={26} />
                  <span>Octoparse 8</span>
                </div>
              </div>
            </div>
            ...
            <div className="links">
              <a
                href="https://github.com/mk870/EnglishPremierLeague_wage_estimator"
                target="_blank"
                rel="noreferrer"
              >
                <div className="btn">
              ...
              <a
                href="https://epl-wage-predictor.onrender.com"
                target="_blank"
                rel="noreferrer"
              >
                <div className="btn">
